...
def addcar():
	...
	if model in car:
		print("该车型已存在")
		choose = input("该车型已存在，是否继续订购1:是2:否")
		while True:
			if choose ==1:
				name = input("请输入车名")
				price = int(input("请输入汽车价格"))
		...
		print("该车名已存在")
		choose = input("该车名已存在，是否继续订购1:是2:否")
		while True:
			if choose ==1:
				name = input("请输入车名")
				price = int(input("请输入汽车价格"))
		...
		print("该价位车型已存在")
		choose = input("该价位车型已存在，是否继续订购1:是2:否")
		while True:
			if choose ==1:
				name = input("请输入车名")
				price = int(input("请输入汽车价格"))
		...
		print("这种颜色的车辆已存在")
		choose = input("这种颜色车辆已存在，是否继续订购1:是2:否")
		while True:
			if choose ==1:
				name = input("请输入车名")
				price = int(input("请输入汽车价格"))
	...
	if home in car:
		print("该厂家的车已存在")
		choose = input("该厂家的车已存在，是否继续订购1:是2:否")
		while True:
			if choose ==1:
				name = input("请输入车名")
				price = int(input("请输入汽车价格"))
